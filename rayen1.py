...
try:
  connections.drop_collection("example_collection2")
except:
...
collection = Collection(name="example_collection2", schema=schema)

# Insert data into Milvus collection
data = [
    [i for i in range(len(encoded_texts))],  # IDs
    [encoded_texts[i]['embedding'] for i in range(len(encoded_texts))]  # Embeddings
]
#print (encoded_texts )
print ( data) 
